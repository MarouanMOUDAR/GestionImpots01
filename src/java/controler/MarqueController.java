...
public class MarqueController implements Serializable {
    ...
    private List<Marque> itemsList;
    private Marque selected;
    private Marque marque;

    public void add() {
        ejbFacade.add(marque, itemsList);
    }
    ...
    public List<Marque> getItemsList() {
        return itemsList;
    }

    public void setItemsList(List<Marque> itemsList) {
    ...
    public MarqueFacade getEjbFacade() {
        return ejbFacade;
    }

    public void setEjbFacade(MarqueFacade ejbFacade) {
